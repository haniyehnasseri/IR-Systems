...
public class BM25_6 extends ScoringFunctionIterator implements DeltaScoringIterator {
    ...
    public BM25_6(NodeParameters np, LengthsIterator ls, CountIterator it)
            throws IOException {
        super(np, ls, it);
    ...
    private double score(double count, double length) {
        ...
        return idf * ( (numerator / denominator) + e);
    }

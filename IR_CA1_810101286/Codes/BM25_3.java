...
public class BM25_3 extends ScoringFunctionIterator implements DeltaScoringIterator {
    ...
    public BM25_3(NodeParameters np, LengthsIterator ls, CountIterator it)
            throws IOException {
        super(np, ls, it);
    ...
    private double score(double count, double length) {
        ...
        double denominator = k * (length/this.avgDocLength) + count;

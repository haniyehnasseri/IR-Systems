...
public class BM25_1 extends ScoringFunctionIterator implements DeltaScoringIterator {
    ...
    public BM25_1(NodeParameters np, LengthsIterator ls, CountIterator it)
            throws IOException {
        super(np, ls, it);

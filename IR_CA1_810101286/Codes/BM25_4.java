...
public class BM25_4 extends ScoringFunctionIterator implements DeltaScoringIterator {
    ...
    public BM25_4(NodeParameters np, LengthsIterator ls, CountIterator it)
            throws IOException {
        super(np, ls, it);

...
@RequiredParameters(parameters = {"k"})
public class BM25_2 extends ScoringFunctionIterator implements DeltaScoringIterator {
    ...
    public BM25_2(NodeParameters np, LengthsIterator ls, CountIterator it)
            throws IOException {
        super(np, ls, it);

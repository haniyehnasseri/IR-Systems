...
@RequiredParameters(parameters = {"b", "k", "d"})
public class BM25_PLAN_1 extends ScoringFunctionIterator implements DeltaScoringIterator {
    ...
    public BM25_PLAN_1(NodeParameters np, LengthsIterator ls, CountIterator it)
            throws IOException {
        super(np, ls, it);
    ...
    private double score(double count, double length) {
        double numerator = count * Math.log(1 + Math.log(1 +count)) * idf ;

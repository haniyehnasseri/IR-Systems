...
public class BM25_PLAN_2 extends ScoringFunctionIterator implements DeltaScoringIterator {
    ...
    public BM25_PLAN_2(NodeParameters np, LengthsIterator ls, CountIterator it)
            throws IOException {
        super(np, ls, it);
    ...
    private double score(double count, double length) {
        double numerator = count * Math.log(1 +count) * idf ;

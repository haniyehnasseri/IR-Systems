...
public class FeatureFactory {
    ...
    static String[][] sOperatorLookup = {
            ...
            {BM25_3.class.getName(), "bm25_1"},
            {BM25_1.class.getName(), "bm25_2"},
            {BM25_2.class.getName(), "bm25_3"},
            {BM25_4.class.getName(), "bm25_4"},
            {BM25_5.class.getName(), "bm25_5"},
            {BM25_6.class.getName(), "bm25_6"},
            {BM25_PLAN_1.class.getName(), "bm25_plan_1"},
            {BM25_PLAN_2.class.getName(), "bm25_plan_2"},
